<div class="site-blocks-cover overlay" style="background-image: url(<?php echo base_url() ?>/assets/front/images/kakbah.jpg);" data-aos="fade"
   ...
   <div class="container">
      <div class="row mt-5 mb-5 justify-content-center">
         <div class="col-md-6">
            <img src="<?= base_url($konten->GAMBAR_PAKET_KATERING) ?>" class="shadow" style="width: 500px;">
         </div>
         <div class="col-md-6">
            <div class="row">
               <div class="col-md-6">
                  <h1 class="font-weight-bold"><?= $konten->NAMA_PAKET_KATERING ?></h1>
                  <h6 class="mt-5">Keterangan</h6>
                  <p><?= $konten->KETERANGAN_PAKET ?></p>
                  <h6 class="mt-5">Harga</h6>
                  <p>Rp. <?= $konten->HARGA_PAKET_KATERING ?></p>
                  <h6 class="mt-5">Spesialisasi</h6>
