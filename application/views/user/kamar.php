<div class="site-blocks-cover overlay" style="background-image: url(<?php echo base_url() ?>/assets/front/images/kakbah.jpg);" data-aos="fade"
      ...
      <div class="container">
        <div class="row align-items-center text-center justify-content-center">
          <div class="col-md-8">
            <h1 class="text-uppercase">Kamar Hotel</h1>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-md-7 text-center">
            ...
            <h2 class="font-weight-bold text-black">Kamar Hotel</h2>
          </div>
        </div>
        <br>
        <h3 class="text-center mt-4">Cari Kamar Hotel</h3>
        <form action="<?php echo base_url('Homepage/index') ?>" method="post">
         <div class="row mx-auto justify-content-center mt-3 mb-5 pt-4" style="height: 40px;">
           <h6 class="mr-2">Cari Kamar Hotel</h6>
        ...
        <hr>
        <h3 class="text-center mt-5">Kamar Hotel</h3>
          ...
          foreach($kamar as $x) { ?>
           <div class="col-md-4 mt-4">
              <div class="card shadow" style="width: 18rem;">
                 <img src="<?= base_url($x->GAMBAR_HOTEL) ?>" class="card-img-top" alt="...">
                 <div class="card-body">
                    <h5 class="card-title"><?= $x->NAMA_KAMAR ?> di Hotel <?= $x->NAMA_HOTEL ?></h5>
                    <a href="<?php echo base_url('Homepage/review_kamar/'.$x->ID_KAMAR) ?>" class="btn btn-primary">Lihat Detail</a>
                 </div>
              </div>
           </div>
          <?php } }else { ?>
